...
export default function Sale() {
  ...
  // Filter for products on sale (originalPrice is set or discount is > 0)
  const saleProducts = dbProducts.filter((product) => {
    return (
    ...
    <div className="min-h-screen bg-background" data-testid="page-sale">
      ...
      <section className="py-12 bg-red-50 dark:bg-red-950/20">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          <span className="bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300 text-xs font-semibold px-2.5 py-1 rounded-full uppercase tracking-wider">
            Special Offers
          </span>
          <h1 className="text-4xl md:text-5xl font-bold font-poppins text-red-600 dark:text-red-400 mt-2 mb-4" data-testid="text-sale-title">
            Season Sale
          </h1>
          <p className="text-lg text-muted-foreground font-open-sans">
            Discover premium clothing at reduced prices. Grab your favorite pieces for your little ones before they sell out!
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">No discounted items found right now. Check back soon for promotions!</p>
            </div>
          ) : (
            <ProductGrid
